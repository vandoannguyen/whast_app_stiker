...
import stickermaker.wastickerapps.stickersforwhatsapp.adx.Config;
import stickermaker.wastickerapps.stickersforwhatsapp.common.Common;
import stickermaker.wastickerapps.stickersforwhatsapp.utils.MediaScannerWrapper;
...
public class LoadingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Common.bannerId = SharedPrefsUtils.getInstance(this).getString(Config.AD_BANNER);
        Common.interId = SharedPrefsUtils.getInstance(this).getString(Config.AD_INTERSTITIAL);
